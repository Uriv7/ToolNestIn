...
export default function PincodeFinder() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <label className="block text-xs font-600 text-slate-400 uppercase tracking-widest mb-2">Enter PIN Code</label>
        ...
        <div className="space-y-3">
          ...
          <div className="bg-brand-500/10 border border-brand-400/30 rounded-2xl p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="font-display font-800 text-xl text-slate-100">PIN: {pincode}</div>
              ...
              {result.PostOffice.map((po: any, i: number) => (
                <div key={i} className="flex items-start gap-3 px-4 py-3 bg-white/3 border border-white/8 rounded-xl">
                  <div className="flex-1">
                    <div className="font-600 text-slate-200 text-sm">{po.Name}</div>
