  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div>
          <label className="block text-xs font-semibold text-slate-400 uppercase tracking-widest mb-2">Lock-in Period</label>
        ...
        <div>
          <label className="block text-xs font-semibold text-slate-400 uppercase tracking-widest mb-2">Extension (5yr blocks)</label>
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="bg-white/3 border border-white/10 rounded-2xl p-4 text-center">
          <div className="font-sans text-xl font-extrabold text-slate-200">{fmt(result.totalInvested)}</div>
          <div className="text-xs text-slate-500 mt-1">Total Invested</div>
        </div>
        <div className="bg-white/3 border border-white/10 rounded-2xl p-4 text-center">
          <div className="font-sans text-xl font-extrabold text-emerald-400">{fmt(result.interest)}</div>
        ...
        <div className="bg-brand-500/15 border border-brand-400/40 rounded-2xl p-4 text-center">
          <div className="font-sans text-xl font-extrabold gradient-text">{fmt(result.maturity)}</div>
      ...
      <div>
        <label className="block text-xs font-semibold text-slate-400 uppercase tracking-widest mb-3">Growth Over {years} Years</label>
