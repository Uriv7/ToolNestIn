    ...
    <div className="space-y-5">
      <div>
        <div className="flex items-center justify-between mb-2">
          <label className="block text-xs font-semibold text-slate-400 uppercase tracking-widest">JWT Token</label>
        ...
        'error' in result ? (
          ...
          <div className="space-y-4">
            ...
            {result.isExpired !== null && (
              <div className={`rounded-xl p-3 text-center text-sm font-semibold ${result.isExpired ? 'bg-rose-500/10 border border-rose-400/30 text-rose-400' : 'bg-emerald-500/10 border border-emerald-400/30 text-emerald-400'}`}>
            ...
            {[
              ...
              <div key={section.key} className="bg-dark-900/80 border border-white/10 rounded-xl overflow-hidden">
                <div className="flex items-center justify-between px-4 py-2.5 border-b border-white/5">
                  <span className="text-xs font-bold text-slate-400 uppercase tracking-widest">{section.label}</span>
            ...
            <div className="bg-dark-900/80 border border-white/10 rounded-xl p-4">
              <div className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-2">Signature</div>
