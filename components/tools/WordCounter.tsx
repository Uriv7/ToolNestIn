...
export default function WordCounter() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <label className="block text-xs font-600 text-slate-400 uppercase tracking-widest mb-2">Paste or type your text</label>
        <textarea
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        {[
          ...
          <div key={s.l} className="glass rounded-xl p-4 text-center">
            <div className="font-display text-2xl font-800 gradient-text">{s.v}</div>
