  ...
  return (
    <div className="space-y-5">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label className="block text-xs font-600 text-slate-400 uppercase tracking-widest mb-2">Date of Birth</label>
          <input type="date" className="tool-input" value={dob} onChange={e => setDob(e.target.value)} max={today} />
        </div>
        <div>
          <label className="block text-xs font-600 text-slate-400 uppercase tracking-widest mb-2">Age At Date</label>
      ...
      {result && (
        <div className="space-y-3">
          <div className="bg-brand-500/10 border border-brand-400/30 rounded-2xl p-6 text-center">
            <div className="font-display text-5xl font-900 gradient-text mb-1">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              <div key={s.l} className="glass rounded-xl p-3 text-center">
                <div className="font-display font-800 text-slate-100 text-lg">{s.v}</div>
