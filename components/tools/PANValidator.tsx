...
export default function PANValidator() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <label className="block text-xs font-600 text-slate-400 uppercase tracking-widest mb-2">Enter PAN Number</label>
        <input
          type="text"
          ...
          {result.valid ? (
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-700 text-emerald-300">Valid PAN Number</div>
                  <div className="font-mono text-2xl font-900 text-slate-100 tracking-widest">{result.formatted}</div>
                </div>
              </div>
              <div className="space-y-2">
                {[
                  ...
                  <div key={r.l} className="flex gap-3 text-sm">
                    ...
                    <span className="text-slate-300 font-600">{r.v}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              <span className="text-2xl">❌</span>
              <div>
                <div className="font-700 text-rose-300">Invalid PAN</div>
      ...
      <div className="glass rounded-xl p-4">
        <h3 className="text-xs font-600 text-slate-400 uppercase tracking-widest mb-3">PAN Format Guide</h3>
