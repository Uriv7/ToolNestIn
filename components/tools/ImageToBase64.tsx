...
export default function ImageToBase64() {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="border-t border-white/5 pt-4"><label className="block text-xs font-semibold text-slate-400 uppercase tracking-widest mb-2">Base64 → Image (Decode)</label>
