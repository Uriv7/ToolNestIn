    ...
    <div className="space-y-5">
      ...
      <div className="bg-brand-500/10 border border-brand-400/20 rounded-xl p-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <code className="font-mono text-brand-300 font-bold">{now}</code>
      ...
      <div className="glass rounded-2xl p-5">
        <h3 className="text-sm font-bold text-slate-300 mb-3">🕐 Unix Timestamp → Human Date</h3>
      ...
      {/* Human → Unix */}
      <div className="glass rounded-2xl p-5">
        <h3 className="text-sm font-bold text-slate-300 mb-3">📅 Human Date → Unix Timestamp</h3>
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            {[
              ...
              <div key={r.l} className="bg-white/3 rounded-xl p-3">
                ...
                <div className="flex items-center gap-2">
                  <code className="font-mono text-brand-300 font-bold text-sm">{r.v}</code>
