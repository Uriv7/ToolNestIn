...
export default function FancyTextGenerator() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <label className="block text-xs font-600 text-slate-400 uppercase tracking-widest mb-2">Your Text</label>
        <input type="text" className="tool-input text-lg font-700" value={input}
