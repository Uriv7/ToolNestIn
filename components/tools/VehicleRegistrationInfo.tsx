        ...
        <div className="bg-gradient-to-br from-brand-950/60 to-dark-800 rounded-2xl border border-brand-400/20 p-5 space-y-3">
          {state ? (<>
            <div className="grid grid-cols-2 gap-3 text-sm">
              <div className="bg-white/5 rounded-xl p-3"><div className="text-slate-400 text-xs mb-1">State</div><div className="text-slate-200 font-bold">{state}</div></div>
              <div className="bg-white/5 rounded-xl p-3"><div className="text-slate-400 text-xs mb-1">RTO Code</div><div className="text-slate-200 font-bold">{stateCode}-{rtoCode}</div></div>
              <div className="bg-white/5 rounded-xl p-3"><div className="text-slate-400 text-xs mb-1">Format</div><div className="text-slate-200 font-bold">{isBH?'Bharat (BH) Series':'Standard State Plate'}</div></div>
              <div className="bg-white/5 rounded-xl p-3"><div className="text-slate-400 text-xs mb-1">Series</div><div className="text-slate-200 font-bold">{upper.slice(4,upper.length-4)||'—'}</div></div>
            </div>
