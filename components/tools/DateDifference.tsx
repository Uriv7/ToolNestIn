      ...
      {result && (
        <div className="space-y-3">
          <div className="bg-brand-500/10 border border-brand-400/30 rounded-2xl p-5 text-center">
            <div className="font-display text-5xl font-900 gradient-text">{result.totalDays.toLocaleString('en-IN')}</div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              ...
              <div key={s.l} className="glass rounded-xl p-3 text-center">
                <div className="font-display font-800 text-slate-100 text-xl">{s.v}</div>
