...
export default function PasswordStrengthChecker() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <label className="block text-xs font-semibold text-slate-400 uppercase tracking-widest mb-2">Enter Password to Check</label>
        ...
        <div className="space-y-4">
          ...
          <div className="glass rounded-2xl p-5">
            <div className="flex items-center justify-between mb-3">
              <span className="font-bold text-lg" style={{ color: analysis.color }}>{analysis.strength}</span>
