...
export default function IdealWeightCalculator() {
  ...
  return (
    <div className="space-y-5">
      ...
      <div><label className="block text-xs font-semibold text-slate-400 uppercase tracking-widest mb-2">Height (cm)</label><input type="number" className="tool-input" value={height} onChange={e => setHeight(e.target.value)} placeholder="170" /></div>
      {h > 0 && (
