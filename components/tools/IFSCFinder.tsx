...
export default function IFSCFinder() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <label className="block text-xs font-600 text-slate-400 uppercase tracking-widest mb-2">Enter IFSC Code</label>
      ...
      {result && (
        <div className="glass rounded-2xl p-5">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <div className="font-display font-800 text-slate-100">{result.BANK}</div>
      ...
      <div className="glass rounded-xl p-4">
        <h3 className="text-xs font-600 text-slate-400 uppercase tracking-widest mb-3">IFSC Code Format</h3>
