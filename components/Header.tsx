        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-15 flex items-center gap-5" style={{ height: '60px' }}>
          ...
          <Link href="/" className="flex items-center gap-2.5 shrink-0 group">
            <div
              ...
              style={{ background: 'linear-gradient(135deg,#0073ce,#36b0fb)', boxShadow: '0 2px 8px rgba(12,147,240,0.4)' }}
              aria-hidden="true"
            >
              🪺
            </div>
            <span className="font-bold text-lg tracking-tight gradient-text hidden sm:block">ToolNestIn</span>
          </Link>
