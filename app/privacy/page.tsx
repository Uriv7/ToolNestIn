...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
      <h1 className="font-display text-4xl font-900 gradient-text mb-2">Privacy Policy</h1>
      <p className="text-slate-500 mb-10 text-sm">Last updated: June 2026 · Effective immediately</p>

      <div className="space-y-6 text-slate-400 leading-relaxed">

        <section className="glass rounded-2xl p-6">
          <h2 className="font-display text-xl font-700 text-slate-100 mb-3">Overview</h2>
          <p className="mb-3">
        ...
        <section className="glass rounded-2xl p-6">
          <h2 className="font-display text-xl font-700 text-slate-100 mb-3">Information We Do Not Collect</h2>
        ...
        <section className="glass rounded-2xl p-6">
          <h2 className="font-display text-xl font-700 text-slate-100 mb-3">Information That Is Collected Automatically</h2>
          <p className="mb-3">
        ...
        <section className="glass rounded-2xl p-6">
          <h2 className="font-display text-xl font-700 text-slate-100 mb-3">Cookies</h2>
          <p className="mb-3">
            ToolNestIn uses the following types of cookies:
          </p>
          <div className="space-y-3 text-sm">
            <div className="bg-white/3 rounded-xl p-4">
              <div className="font-600 text-slate-200 mb-1">Google AdSense Cookies</div>
            ...
            <div className="bg-white/3 rounded-xl p-4">
              <div className="font-600 text-slate-200 mb-1">Google Analytics Cookies</div>
            ...
            <div className="bg-white/3 rounded-xl p-4">
              <div className="font-600 text-slate-200 mb-1">No First-Party Cookies</div>
        ...
        <section className="glass rounded-2xl p-6">
          <h2 className="font-display text-xl font-700 text-slate-100 mb-3">Google AdSense & Advertising</h2>
          <p className="mb-3">
        ...
        <section className="glass rounded-2xl p-6">
          <h2 className="font-display text-xl font-700 text-slate-100 mb-3">Third-Party Services</h2>
          <div className="space-y-3 text-sm">
            {[
              ...
              <div key={s.name} className="bg-white/3 rounded-xl p-4">
                <div className="font-600 text-slate-200 mb-1">{s.name}</div>
        ...
        <section className="glass rounded-2xl p-6">
          <h2 className="font-display text-xl font-700 text-slate-100 mb-3">Children&apos;s Privacy</h2>
          <p>
        ...
        <section className="glass rounded-2xl p-6">
          <h2 className="font-display text-xl font-700 text-slate-100 mb-3">Data Security</h2>
          <p>
        ...
        <section className="glass rounded-2xl p-6">
          <h2 className="font-display text-xl font-700 text-slate-100 mb-3">Your Rights</h2>
          <p className="mb-3">
        ...
        <section className="glass rounded-2xl p-6">
          <h2 className="font-display text-xl font-700 text-slate-100 mb-3">Changes to This Policy</h2>
          <p>
        ...
        <section className="glass rounded-2xl p-6">
          <h2 className="font-display text-xl font-700 text-slate-100 mb-3">GDPR and International Visitors</h2>
        ...
        <section className="glass rounded-2xl p-6">
          <h2 className="font-display text-xl font-700 text-slate-100 mb-3">Financial and Health Tool Disclaimer</h2>
          <p className="text-sm mb-3">
        ...
        <section className="glass rounded-2xl p-6">
          <h2 className="font-display text-xl font-700 text-slate-100 mb-3">Contact</h2>
          <p className="mb-3">
            If you have any questions about this Privacy Policy or our data practices, please contact us:
          </p>
          <div className="text-sm space-y-1">
            <div><span className="text-slate-300 font-600">Email:</span> <a href="mailto:privacy@toolnestin.co.in" className="text-brand-400 hover:underline">privacy@toolnestin.co.in</a></div>
            <div><span className="text-slate-300 font-600">Website:</span> <Link href="/" className="text-brand-400 hover:underline">toolnestin.co.in</Link></div>
          </div>
        </section>
