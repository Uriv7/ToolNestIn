  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="mb-12 text-center">
        ...
        <h1 className="font-display text-4xl sm:text-5xl font-900 gradient-text mb-5">About ToolNestIn</h1>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-14">
        ...
        <div className="glass rounded-2xl p-5 text-center">
          <div className="font-display text-3xl font-800 gradient-text">{TOOLS.length}+</div>
          <div className="text-slate-500 text-sm mt-1">Free Tools</div>
        </div>
        {STATS.map(s => (
          <div key={s.l} className="glass rounded-2xl p-5 text-center">
            <div className="font-display text-3xl font-800 gradient-text">{s.v}</div>
      ...
      <section className="glass rounded-2xl p-8 mb-8">
        <h2 className="font-display text-2xl font-700 text-slate-100 mb-4">Why We Built ToolNestIn</h2>
      ...
      <div className="space-y-6 mb-14">
        <h2 className="font-display text-2xl font-700 text-slate-100">What Makes ToolNestIn Different</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          {WHY_US.map(item => (
            <section key={item.title} className="glass rounded-2xl p-6">
              <div className="flex items-center gap-3 mb-3">
                <span className="text-2xl" aria-hidden="true">{item.icon}</span>
                <h3 className="font-display font-700 text-slate-100 text-lg">{item.title}</h3>
              </div>
      ...
      <section className="glass rounded-2xl p-8 mb-10">
        <h2 className="font-display text-2xl font-700 text-slate-100 mb-6">Our Most-Used India Tools</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {TOOLS_HIGHLIGHT.map(t => (
            ...
            >
              <div>
                <div className="font-600 text-brand-300 text-sm">{t.label}</div>
      ...
      {/* How we sustain */}
      <section className="glass rounded-2xl p-8 mb-10">
        <h2 className="font-display text-2xl font-700 text-slate-100 mb-4">How We Keep the Lights On</h2>
      ...
      <div className="text-center">
        <h2 className="font-display text-xl font-700 text-slate-200 mb-3">Have a suggestion or found a bug?</h2>
        ...
        <div className="flex flex-wrap justify-center gap-3">
          ...
          <Link href="/" className="px-5 py-2.5 rounded-xl border border-white/10 text-slate-400 hover:text-slate-200 hover:border-white/20 transition text-sm font-600">Browse All Tools →</Link>
        </div>
      </div>
